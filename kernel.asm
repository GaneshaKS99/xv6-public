...
801035f7:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
801035fd:	e8 2e 0e 00 00       	call   80104430 <release>
...
8010361f:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103622:	c7 40 14 a1 56 10 80 	movl   $0x801056a1,0x14(%eax)
...
8010362e:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103631:	e8 4a 0e 00 00       	call   80104480 <memset>
...
80103658:	e8 d3 0d 00 00       	call   80104430 <release>
  return 0;
...
8010367b:	e8 b0 0d 00 00       	call   80104430 <release>
...
801036d0:	e8 4b 0b 00 00       	call   80104220 <initlock>
}
...
8010374a:	68 90 75 10 80       	push   $0x80107590
...
80103784:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103787:	e8 14 0b 00 00       	call   801042a0 <pushcli>
  c = mycpu();
8010378c:	e8 4f ff ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103791:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103797:	e8 44 0b 00 00       	call   801042e0 <popcli>
  return p;
}
...
801037f6:	e8 85 0c 00 00       	call   80104480 <memset>
...
80103855:	e8 26 0e 00 00       	call   80104680 <safestrcpy>
  p->cwd = namei("/");
...
80103870:	e8 0b 0b 00 00       	call   80104380 <acquire>
...
80103883:	e8 a8 0b 00 00       	call   80104430 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
801038a8:	e8 f3 09 00 00       	call   801042a0 <pushcli>
  c = mycpu();
801038ad:	e8 2e fe ff ff       	call   801036e0 <mycpu>
  p = c->proc;
801038b2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038b8:	e8 23 0a 00 00       	call   801042e0 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103929:	e8 72 09 00 00       	call   801042a0 <pushcli>
  c = mycpu();
8010392e:	e8 ad fd ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103933:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103939:	e8 a2 09 00 00       	call   801042e0 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
801039d1:	e8 aa 0c 00 00       	call   80104680 <safestrcpy>
...
801039e0:	e8 9b 09 00 00       	call   80104380 <acquire>
...
801039f3:	e8 38 0a 00 00       	call   80104430 <release>
...
80103a6e:	e8 0d 09 00 00       	call   80104380 <acquire>
...
80103aa9:	c7 43 8c 04 00 00 00 	movl   $0x4,-0x74(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103ab0:	e8 26 0c 00 00       	call   801046db <swtch>
      switchkvm();
...
80104018:	8b 14 85 d0 75 10 80 	mov    -0x7fef8a30(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
801040bb:	ff 34 95 b8 75 10 80 	pushl  -0x7fef8a48(,%edx,4)
801040c2:	53                   	push   %ebx
801040c3:	83 eb 80             	sub    $0xffffff80,%ebx
801040c6:	50                   	push   %eax
801040c7:	68 4d 75 10 80       	push   $0x8010754d
...
801040fa:	68 e8 75 10 80       	push   $0x801075e8
...
80104163:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104169:	e8 12 f6 ff ff       	call   80103780 <myproc>
...
801041f3:	e8 88 f5 ff ff       	call   80103780 <myproc>
...
801042bf:	e8 1c f4 ff ff       	call   801036e0 <mycpu>
801042c4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801042ca:	e8 11 f4 ff ff       	call   801036e0 <mycpu>
...
801042eb:	75 52                	jne    8010433f <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
801042ed:	e8 ee f3 ff ff       	call   801036e0 <mycpu>
...
80104305:	e8 d6 f3 ff ff       	call   801036e0 <mycpu>
...
80104319:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104320:	e8 bb f3 ff ff       	call   801036e0 <mycpu>
...
80104335:	68 0a 76 10 80       	push   $0x8010760a
...
80104342:	68 f3 75 10 80       	push   $0x801075f3
...
80104368:	e8 73 f3 ff ff       	call   801036e0 <mycpu>
...
801043c4:	e8 17 f3 ff ff       	call   801036e0 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
80104423:	68 11 76 10 80       	push   $0x80107611
...
8010446c:	68 19 76 10 80       	push   $0x80107619
...
80104795:	e8 e6 ef ff ff       	call   80103780 <myproc>
...
{
  struct proc *curproc = myproc();
801047a6:	e8 d5 ef ff ff       	call   80103780 <myproc>
...
801047e8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801047eb:	e8 90 ef ff ff       	call   80103780 <myproc>
...
80104884:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104885:	e8 f6 ee ff ff       	call   80103780 <myproc>
...
801048c0:	68 21 76 10 80       	push   $0x80107621
