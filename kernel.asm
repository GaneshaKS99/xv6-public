...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 a2 75 10 80 	movl   $0x801075a2,(%esp)
...
80101255:	e8 56 32 00 00       	call   801044b0 <memset>
  log_write(bp);
...
801012df:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012e2:	e8 79 31 00 00       	call   80104460 <release>
      return ip;
...
8010132f:	e8 2c 31 00 00       	call   80104460 <release>
...
80101441:	e8 1a 31 00 00       	call   80104560 <memmove>
  brelse(bp);
...
80101476:	e8 d5 2d 00 00       	call   80104250 <initlock>
...
8010148f:	e8 8c 2c 00 00       	call   80104120 <initsleeplock>
iinit(int dev)
{
  int i = 0;
...
8010163f:	e8 6c 2d 00 00       	call   801043b0 <acquire>
  ip->ref++;
...
80101682:	e8 d9 2a 00 00       	call   80104160 <acquiresleep>
...
80101753:	e8 a8 2a 00 00       	call   80104200 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
8010176f:	e9 4c 2a 00 00       	jmp    801041c0 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
801017a0:	e8 bb 29 00 00       	call   80104160 <acquiresleep>
...
801017ba:	e8 01 2a 00 00       	call   801041c0 <releasesleep>

  acquire(&icache.lock);
801017bf:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017c6:	e8 e5 2b 00 00       	call   801043b0 <acquire>
  ip->ref--;
...
801017df:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
801017e0:	e9 7b 2c 00 00       	jmp    80104460 <release>
...
801017f0:	e8 bb 2b 00 00       	call   801043b0 <acquire>
    int r = ip->ref;
801017f5:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
801017f8:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017ff:	e8 5c 2c 00 00       	call   80104460 <release>
    if(r == 1){
...
80101c69:	e8 42 27 00 00       	call   801043b0 <acquire>
  ip->ref++;
80101c6e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c72:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c79:	e8 e2 27 00 00       	call   80104460 <release>
...
80101e98:	68 22 77 10 80       	push   $0x80107722
...
80101fd0:	e8 7b 22 00 00       	call   80104250 <initlock>
...
8010204e:	e8 5d 23 00 00       	call   801043b0 <acquire>
...
8010209c:	e8 bf 23 00 00       	call   80104460 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801020ee:	e8 0d 21 00 00       	call   80104200 <holdingsleep>
...
80102128:	e8 83 22 00 00       	call   801043b0 <acquire>
...
80102195:	c9                   	leave  
  ...
  release(&idelock);
80102196:	e9 c5 22 00 00       	jmp    80104460 <release>
...
80102348:	e8 63 20 00 00       	call   801043b0 <acquire>
...
801023c5:	e8 86 1e 00 00       	call   80104250 <initlock>
...
801024c8:	e8 e3 1e 00 00       	call   801043b0 <acquire>
  r = kmem.freelist;
...
801028d4:	e8 27 1c 00 00       	call   80104500 <memcmp>
...
80102a04:	e8 57 1b 00 00       	call   80104560 <memmove>
...
80102ab4:	e8 97 17 00 00       	call   80104250 <initlock>
  readsb(dev, &sb);
80102ab9:	58                   	pop    %eax
...
80102b4b:	e8 60 18 00 00       	call   801043b0 <acquire>
...
80102b9c:	e8 bf 18 00 00       	call   80104460 <release>
      break;
    }
  }
}
...
80102bbe:	e8 ed 17 00 00       	call   801043b0 <acquire>
  log.outstanding -= 1;
...
80102bfd:	e8 5e 18 00 00       	call   80104460 <release>
}
...
80102c5c:	e8 ff 18 00 00       	call   80104560 <memmove>
...
80102ca5:	e8 06 17 00 00       	call   801043b0 <acquire>
    log.committing = 0;
    wakeup(&log);
...
80102cc7:	e8 94 17 00 00       	call   80104460 <release>
...
80102cf4:	e8 67 17 00 00       	call   80104460 <release>
...
80102d5e:	e8 4d 16 00 00       	call   801043b0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dad:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102dae:	e9 ad 16 00 00       	jmp    80104460 <release>
80102db3:	90                   	nop
...
80102ec9:	e8 92 16 00 00       	call   80104560 <memmove>
...
80102f9e:	e8 5d 15 00 00       	call   80104500 <memcmp>
...
80103062:	e8 99 14 00 00       	call   80104500 <memcmp>
...
80103259:	e8 f2 0f 00 00       	call   80104250 <initlock>
  (*f0)->type = FD_PIPE;
...
801032ef:	e8 bc 10 00 00       	call   801043b0 <acquire>
  if(writable){
...
80103333:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103334:	e9 27 11 00 00       	jmp    80104460 <release>
...
80103364:	e8 f7 10 00 00       	call   80104460 <release>
    kfree((char*)p);
...
8010338d:	e8 1e 10 00 00       	call   801043b0 <acquire>
  for(i = 0; i < n; i++){
...
80103414:	e8 47 10 00 00       	call   80104460 <release>
        return -1;
...
8010346b:	e8 f0 0f 00 00       	call   80104460 <release>
  return n;
...
80103490:	e8 1b 0f 00 00       	call   801043b0 <acquire>
...
801034f9:	e8 62 0f 00 00       	call   80104460 <release>
      return -1;
...
80103566:	e8 f5 0e 00 00       	call   80104460 <release>
  return i;
...
801035b1:	e8 fa 0d 00 00       	call   801043b0 <acquire>
...
801035ec:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
801035f2:	e8 69 0e 00 00       	call   80104460 <release>
...
80103614:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103617:	c7 40 14 d1 56 10 80 	movl   $0x801056d1,0x14(%eax)
...
80103623:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103626:	e8 85 0e 00 00       	call   801044b0 <memset>
...
80103648:	e8 13 0e 00 00       	call   80104460 <release>
  return 0;
...
8010366b:	e8 f0 0d 00 00       	call   80104460 <release>
...
801036c0:	e8 8b 0b 00 00       	call   80104250 <initlock>
}
...
8010373a:	68 00 76 10 80       	push   $0x80107600
...
80103774:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103777:	e8 54 0b 00 00       	call   801042d0 <pushcli>
  c = mycpu();
8010377c:	e8 4f ff ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103781:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103787:	e8 84 0b 00 00       	call   80104310 <popcli>
  return p;
}
...
801037b3:	e8 08 35 00 00       	call   80106cc0 <setupkvm>
...
801037d1:	e8 fa 31 00 00       	call   801069d0 <inituvm>
  p->sz = PGSIZE;
...
801037e6:	e8 c5 0c 00 00       	call   801044b0 <memset>
...
80103845:	e8 66 0e 00 00       	call   801046b0 <safestrcpy>
  p->cwd = namei("/");
...
80103860:	e8 4b 0b 00 00       	call   801043b0 <acquire>
...
80103873:	e8 e8 0b 00 00       	call   80104460 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103898:	e8 33 0a 00 00       	call   801042d0 <pushcli>
  c = mycpu();
8010389d:	e8 2e fe ff ff       	call   801036d0 <mycpu>
  p = c->proc;
801038a2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038a8:	e8 63 0a 00 00       	call   80104310 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
801038be:	e8 4d 32 00 00       	call   80106b10 <allocuvm>
...
801038d0:	e8 eb 2f 00 00       	call   801068c0 <switchuvm>
  return 0;
...
801038f4:	e8 17 33 00 00       	call   80106c10 <deallocuvm>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103919:	e8 b2 09 00 00       	call   801042d0 <pushcli>
  c = mycpu();
8010391e:	e8 ad fd ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103923:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103929:	e8 e2 09 00 00       	call   80104310 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
80103948:	e8 43 34 00 00       	call   80106d90 <copyuvm>
...
801039c1:	e8 ea 0c 00 00       	call   801046b0 <safestrcpy>
...
801039d0:	e8 db 09 00 00       	call   801043b0 <acquire>
...
801039e3:	e8 78 0a 00 00       	call   80104460 <release>
...
80103a5e:	e8 4d 09 00 00       	call   801043b0 <acquire>
...
80103a8b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a8e:	e8 2d 2e 00 00       	call   801068c0 <switchuvm>
      p->state = RUNNING;
...
80103a99:	c7 43 90 04 00 00 00 	movl   $0x4,-0x70(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103aa0:	e8 66 0c 00 00       	call   8010470b <swtch>
      switchkvm();
80103aa5:	e8 f6 2d 00 00       	call   801068a0 <switchkvm>
...
80103ac8:	e8 93 09 00 00       	call   80104460 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ae5:	e8 e6 07 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103aea:	e8 e1 fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103aef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103af5:	e8 16 08 00 00       	call   80104310 <popcli>
sched(void)
{
  int intena;
...
80103b02:	e8 79 08 00 00       	call   80104380 <holding>
...
80103b43:	e8 c3 0b 00 00       	call   8010470b <swtch>
  mycpu()->intena = intena;
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ba9:	e8 22 07 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103bae:	e8 1d fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103bb3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bb9:	e8 52 07 00 00       	call   80104310 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103c12:	e8 99 07 00 00       	call   801043b0 <acquire>
...
80103cdc:	e8 cf 06 00 00       	call   801043b0 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103ce1:	e8 ea 05 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103ce6:	e8 e5 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103ceb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cf1:	e8 1a 06 00 00       	call   80104310 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103d09:	e8 52 07 00 00       	call   80104460 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d2f:	e8 9c 05 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103d34:	e8 97 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103d39:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d3f:	e8 cc 05 00 00       	call   80104310 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103d60:	e8 4b 06 00 00       	call   801043b0 <acquire>
    release(lk);
80103d65:	89 34 24             	mov    %esi,(%esp)
80103d68:	e8 f3 06 00 00       	call   80104460 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d8a:	e8 d1 06 00 00       	call   80104460 <release>
    acquire(lk);
...
80103d9b:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103d9c:	e9 0f 06 00 00       	jmp    801043b0 <acquire>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103de5:	e8 e6 04 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103dea:	e8 e1 f8 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103def:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103df5:	e8 16 05 00 00       	call   80104310 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103e02:	e8 a9 05 00 00       	call   801043b0 <acquire>
...
80103e70:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e77:	e8 c4 2d 00 00       	call   80106c40 <freevm>
        p->pid = 0;
...
80103ea3:	e8 b8 05 00 00       	call   80104460 <release>
        return pid;
...
80103ebc:	e8 9f 05 00 00       	call   80104460 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f21:	e9 3a 05 00 00       	jmp    80104460 <release>
...
80103f3f:	e8 6c 04 00 00       	call   801043b0 <acquire>
...
80103f74:	e8 e7 04 00 00       	call   80104460 <release>
      return 0;
...
80103fa0:	e8 bb 04 00 00       	call   80104460 <release>
  return -1;
...
80103fdb:	68 a2 75 10 80       	push   $0x801075a2
...
80104008:	8b 14 85 28 76 10 80 	mov    -0x7fef89d8(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
80104045:	e8 26 02 00 00       	call   80104270 <getcallerpcs>
...
80104092:	e8 19 03 00 00       	call   801043b0 <acquire>
  cprintf(" name \t pid \t state  \n");
80104097:	c7 04 24 8d 75 10 80 	movl   $0x8010758d,(%esp)
8010409e:	e8 bd c5 ff ff       	call   80100660 <cprintf>
801040a3:	83 c4 10             	add    $0x10,%esp
801040a6:	eb 18                	jmp    801040c0 <cps+0x40>
801040a8:	90                   	nop
...
801040b5:	83 c3 7c             	add    $0x7c,%ebx
{
struct proc *p;
  sti();
  acquire(&ptable.lock);
  cprintf(" name \t pid \t state  \n");
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040b8:	81 fb c0 4c 11 80    	cmp    $0x80114cc0,%ebx
801040be:	74 27                	je     801040e7 <cps+0x67>
      if ( p->state == SLEEPING )
801040c0:	8b 43 a0             	mov    -0x60(%ebx),%eax
801040c3:	83 f8 02             	cmp    $0x2,%eax
801040c6:	75 e8                	jne    801040b0 <cps+0x30>
        cprintf("(%s \t %d  \t SLEEPING) \n ", p->name, p->pid );
801040c8:	83 ec 04             	sub    $0x4,%esp
801040cb:	ff 73 a4             	pushl  -0x5c(%ebx)
801040ce:	53                   	push   %ebx
801040cf:	68 a4 75 10 80       	push   $0x801075a4
801040d4:	83 c3 7c             	add    $0x7c,%ebx
...
struct proc *p;
  ...
  cprintf(" name \t pid \t state  \n");
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040df:	81 fb c0 4c 11 80    	cmp    $0x80114cc0,%ebx
801040e5:	75 d9                	jne    801040c0 <cps+0x40>
      if ( p->state == SLEEPING )
        cprintf("(%s \t %d  \t SLEEPING) \n ", p->name, p->pid );
      else if ( p->state == RUNNING )
        cprintf("(%s \t %d  \t RUNNING) \n", p->name, p->pid );
...
801040ef:	e8 6c 03 00 00       	call   80104460 <release>
  return 22;


}
801040f4:	b8 16 00 00 00       	mov    $0x16,%eax
801040f9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801040fc:	c9                   	leave  
801040fd:	c3                   	ret    
...
80104103:	ff 73 a4             	pushl  -0x5c(%ebx)
80104106:	53                   	push   %ebx
80104107:	68 bd 75 10 80       	push   $0x801075bd
8010410c:	e8 4f c5 ff ff       	call   80100660 <cprintf>
80104111:	83 c4 10             	add    $0x10,%esp
80104114:	eb 9f                	jmp    801040b5 <cps+0x35>
...
8010412a:	68 40 76 10 80       	push   $0x80107640
...
8010416f:	e8 3c 02 00 00       	call   801043b0 <acquire>
  while (lk->locked) {
...
80104185:	e8 96 fb ff ff       	call   80103d20 <sleep>
...
80104193:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104199:	e8 d2 f5 ff ff       	call   80103770 <myproc>
...
801041ac:	5d                   	pop    %ebp
  ...
  lk->pid = myproc()->pid;
  release(&lk->lk);
801041ad:	e9 ae 02 00 00       	jmp    80104460 <release>
...
801041cf:	e8 dc 01 00 00       	call   801043b0 <acquire>
  lk->locked = 0;
...
801041e4:	e8 e7 fc ff ff       	call   80103ed0 <wakeup>
  release(&lk->lk);
...
801041f4:	5d                   	pop    %ebp
{
  ...
  wakeup(lk);
  release(&lk->lk);
801041f5:	e9 66 02 00 00       	jmp    80104460 <release>
...
80104212:	e8 99 01 00 00       	call   801043b0 <acquire>
...
80104223:	e8 48 f5 ff ff       	call   80103770 <myproc>
...
80104237:	e8 24 02 00 00       	call   80104460 <release>
  return r;
}
...
801042ef:	e8 dc f3 ff ff       	call   801036d0 <mycpu>
...
8010431b:	75 52                	jne    8010436f <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010431d:	e8 ae f3 ff ff       	call   801036d0 <mycpu>
...
80104335:	e8 96 f3 ff ff       	call   801036d0 <mycpu>
...
80104349:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104350:	e8 7b f3 ff ff       	call   801036d0 <mycpu>
...
80104365:	68 62 76 10 80       	push   $0x80107662
...
80104372:	68 4b 76 10 80       	push   $0x8010764b
...
80104388:	31 db                	xor    %ebx,%ebx
  int r;
  pushcli();
8010438a:	e8 41 ff ff ff       	call   801042d0 <pushcli>
...
80104398:	e8 33 f3 ff ff       	call   801036d0 <mycpu>
8010439d:	39 c3                	cmp    %eax,%ebx
8010439f:	0f 94 c3             	sete   %bl
801043a2:	0f b6 db             	movzbl %bl,%ebx
  popcli();
801043a5:	e8 66 ff ff ff       	call   80104310 <popcli>
  return r;
}
...
801043b7:	e8 14 ff ff ff       	call   801042d0 <pushcli>
  if(holding(lk))
801043bc:	8b 5d 08             	mov    0x8(%ebp),%ebx
801043bf:	83 ec 0c             	sub    $0xc,%esp
801043c2:	53                   	push   %ebx
801043c3:	e8 b8 ff ff ff       	call   80104380 <holding>
801043c8:	83 c4 10             	add    $0x10,%esp
801043cb:	85 c0                	test   %eax,%eax
801043cd:	0f 85 7d 00 00 00    	jne    80104450 <acquire+0xa0>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
801043f4:	e8 d7 f2 ff ff       	call   801036d0 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
80104426:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104429:	c9                   	leave  
8010442a:	c3                   	ret    
8010442b:	90                   	nop
...
8010443d:	74 e7                	je     80104426 <acquire+0x76>
    pcs[i] = 0;
...
8010444c:	75 e2                	jne    80104430 <acquire+0x80>
8010444e:	eb d6                	jmp    80104426 <acquire+0x76>
void
acquire(struct spinlock *lk)
{
  pushcli(); // disable interrupts to avoid deadlock.
...
80104453:	68 69 76 10 80       	push   $0x80107669
...
8010446b:	e8 10 ff ff ff       	call   80104380 <holding>
...
8010449c:	68 71 76 10 80       	push   $0x80107671
...
80104767:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010476a:	e8 01 f0 ff ff       	call   80103770 <myproc>
...
801047c5:	e8 a6 ef ff ff       	call   80103770 <myproc>
...
{
  struct proc *curproc = myproc();
801047d6:	e8 95 ef ff ff       	call   80103770 <myproc>
...
80104818:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010481b:	e8 50 ef ff ff       	call   80103770 <myproc>
...
801048b4:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
801048b5:	e8 b6 ee ff ff       	call   80103770 <myproc>
...
801048ca:	8b 14 85 a0 76 10 80 	mov    -0x7fef8960(,%eax,4),%edx
...
801048f0:	68 79 76 10 80       	push   $0x80107679
...
80104a54:	68 18 77 10 80       	push   $0x80107718
...
80104a6c:	68 17 77 10 80       	push   $0x80107717
...
80104a81:	68 0b 77 10 80       	push   $0x8010770b
...
80104a8e:	68 1a 77 10 80       	push   $0x8010771a
...
80104a9b:	68 fc 76 10 80       	push   $0x801076fc
...
80104ead:	58                   	pop    %eax
80104eae:	5a                   	pop    %edx
80104eaf:	68 18 77 10 80       	push   $0x80107718
...
80104ec8:	68 17 77 10 80       	push   $0x80107717
...
8010501d:	68 3c 77 10 80       	push   $0x8010773c
...
8010502a:	68 4e 77 10 80       	push   $0x8010774e
...
80105037:	68 2a 77 10 80       	push   $0x8010772a
...
80105513:	83 ec 08             	sub    $0x8,%esp
  exit();
80105516:	e8 85 e6 ff ff       	call   80103ba0 <exit>
...
{
  return wait();
80105524:	e9 b7 e8 ff ff       	jmp    80103de0 <wait>
...
8010554e:	e8 dd e9 ff ff       	call   80103f30 <kill>
...
8010561d:	e8 fe e6 ff ff       	call   80103d20 <sleep>
...
{
 return cps();
801056b4:	e9 c7 e9 ff ff       	jmp    80104080 <cps>
...
801056c8:	54                   	push   %esp
  call trap
801056c9:	e8 e2 00 00 00       	call   801057b0 <trap>
  addl $4, %esp
...
80105739:	68 5d 77 10 80       	push   $0x8010775d
...
801057d0:	ff 24 85 04 78 10 80 	jmp    *-0x7fef87fc(,%eax,4)
...
801057e0:	e8 8b df ff ff       	call   80103770 <myproc>
...
80105835:	68 c0 77 10 80       	push   $0x801077c0
...
80105865:	e8 06 df ff ff       	call   80103770 <myproc>
8010586a:	85 c0                	test   %eax,%eax
8010586c:	74 0b                	je     80105879 <trap+0xc9>
8010586e:	e8 fd de ff ff       	call   80103770 <myproc>
...
80105877:	74 4f                	je     801058c8 <trap+0x118>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105879:	e8 f2 de ff ff       	call   80103770 <myproc>
...
801058bb:	75 a8                	jne    80105865 <trap+0xb5>
    exit();
801058bd:	e8 de e2 ff ff       	call   80103ba0 <exit>
...
801058cc:	75 ab                	jne    80105879 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
801058ce:	e8 fd e3 ff ff       	call   80103cd0 <yield>
...
801058d5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801058d8:	e8 73 de ff ff       	call   80103750 <cpuid>
...
80105917:	e8 34 de ff ff       	call   80103750 <cpuid>
8010591c:	56                   	push   %esi
8010591d:	53                   	push   %ebx
8010591e:	50                   	push   %eax
8010591f:	68 68 77 10 80       	push   $0x80107768
...
8010597f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105980:	e9 1b e2 ff ff       	jmp    80103ba0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105988:	e8 13 e2 ff ff       	call   80103ba0 <exit>
...
801059a4:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
801059ab:	e8 20 e5 ff ff       	call   80103ed0 <wakeup>
      release(&tickslock);
...
801059ca:	e8 81 dd ff ff       	call   80103750 <cpuid>
...
801059d8:	68 8c 77 10 80       	push   $0x8010778c
801059dd:	e8 7e ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801059e2:	83 c4 14             	add    $0x14,%esp
801059e5:	68 62 77 10 80       	push   $0x80107762
...
80105adf:	bb 84 78 10 80       	mov    $0x80107884,%ebx
...
80105b77:	6a 00                	push   $0x0
  jmp alltraps
80105b79:	e9 3b fb ff ff       	jmp    801056b9 <alltraps>
...
80105b80:	6a 01                	push   $0x1
  jmp alltraps
80105b82:	e9 32 fb ff ff       	jmp    801056b9 <alltraps>
...
80105b89:	6a 02                	push   $0x2
  jmp alltraps
80105b8b:	e9 29 fb ff ff       	jmp    801056b9 <alltraps>
...
80105b92:	6a 03                	push   $0x3
  jmp alltraps
80105b94:	e9 20 fb ff ff       	jmp    801056b9 <alltraps>
...
80105b9b:	6a 04                	push   $0x4
  jmp alltraps
80105b9d:	e9 17 fb ff ff       	jmp    801056b9 <alltraps>
...
80105ba4:	6a 05                	push   $0x5
  jmp alltraps
80105ba6:	e9 0e fb ff ff       	jmp    801056b9 <alltraps>
...
80105bad:	6a 06                	push   $0x6
  jmp alltraps
80105baf:	e9 05 fb ff ff       	jmp    801056b9 <alltraps>
...
80105bb6:	6a 07                	push   $0x7
  jmp alltraps
80105bb8:	e9 fc fa ff ff       	jmp    801056b9 <alltraps>
...
80105bbd:	6a 08                	push   $0x8
  jmp alltraps
80105bbf:	e9 f5 fa ff ff       	jmp    801056b9 <alltraps>
...
80105bc6:	6a 09                	push   $0x9
  jmp alltraps
80105bc8:	e9 ec fa ff ff       	jmp    801056b9 <alltraps>
...
80105bd4:	6a 0b                	push   $0xb
  jmp alltraps
80105bd6:	e9 de fa ff ff       	jmp    801056b9 <alltraps>
...
80105bdb:	6a 0c                	push   $0xc
  jmp alltraps
80105bdd:	e9 d7 fa ff ff       	jmp    801056b9 <alltraps>
...
80105be2:	6a 0d                	push   $0xd
  jmp alltraps
80105be4:	e9 d0 fa ff ff       	jmp    801056b9 <alltraps>
...
80105be9:	6a 0e                	push   $0xe
  jmp alltraps
80105beb:	e9 c9 fa ff ff       	jmp    801056b9 <alltraps>
...
80105bf2:	6a 0f                	push   $0xf
  jmp alltraps
80105bf4:	e9 c0 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c0b:	6a 12                	push   $0x12
  jmp alltraps
80105c0d:	e9 a7 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c14:	6a 13                	push   $0x13
  jmp alltraps
80105c16:	e9 9e fa ff ff       	jmp    801056b9 <alltraps>
...
80105c1d:	6a 14                	push   $0x14
  jmp alltraps
80105c1f:	e9 95 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c26:	6a 15                	push   $0x15
  jmp alltraps
80105c28:	e9 8c fa ff ff       	jmp    801056b9 <alltraps>
...
80105c2f:	6a 16                	push   $0x16
  jmp alltraps
80105c31:	e9 83 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c38:	6a 17                	push   $0x17
  jmp alltraps
80105c3a:	e9 7a fa ff ff       	jmp    801056b9 <alltraps>
...
80105c41:	6a 18                	push   $0x18
  jmp alltraps
80105c43:	e9 71 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c4a:	6a 19                	push   $0x19
  jmp alltraps
80105c4c:	e9 68 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c53:	6a 1a                	push   $0x1a
  jmp alltraps
80105c55:	e9 5f fa ff ff       	jmp    801056b9 <alltraps>
...
80105c5c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c5e:	e9 56 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c65:	6a 1c                	push   $0x1c
  jmp alltraps
80105c67:	e9 4d fa ff ff       	jmp    801056b9 <alltraps>
...
80105c6e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c70:	e9 44 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c77:	6a 1e                	push   $0x1e
  jmp alltraps
80105c79:	e9 3b fa ff ff       	jmp    801056b9 <alltraps>
...
80105c80:	6a 1f                	push   $0x1f
  jmp alltraps
80105c82:	e9 32 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c89:	6a 20                	push   $0x20
  jmp alltraps
80105c8b:	e9 29 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c92:	6a 21                	push   $0x21
  jmp alltraps
80105c94:	e9 20 fa ff ff       	jmp    801056b9 <alltraps>
...
80105c9b:	6a 22                	push   $0x22
  jmp alltraps
80105c9d:	e9 17 fa ff ff       	jmp    801056b9 <alltraps>
...
80105ca4:	6a 23                	push   $0x23
  jmp alltraps
80105ca6:	e9 0e fa ff ff       	jmp    801056b9 <alltraps>
...
80105cad:	6a 24                	push   $0x24
  jmp alltraps
80105caf:	e9 05 fa ff ff       	jmp    801056b9 <alltraps>
...
80105cb6:	6a 25                	push   $0x25
  jmp alltraps
80105cb8:	e9 fc f9 ff ff       	jmp    801056b9 <alltraps>
...
80105cbf:	6a 26                	push   $0x26
  jmp alltraps
80105cc1:	e9 f3 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105cc8:	6a 27                	push   $0x27
  jmp alltraps
80105cca:	e9 ea f9 ff ff       	jmp    801056b9 <alltraps>
...
80105cd1:	6a 28                	push   $0x28
  jmp alltraps
80105cd3:	e9 e1 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105cda:	6a 29                	push   $0x29
  jmp alltraps
80105cdc:	e9 d8 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105ce3:	6a 2a                	push   $0x2a
  jmp alltraps
80105ce5:	e9 cf f9 ff ff       	jmp    801056b9 <alltraps>
...
80105cec:	6a 2b                	push   $0x2b
  jmp alltraps
80105cee:	e9 c6 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105cf5:	6a 2c                	push   $0x2c
  jmp alltraps
80105cf7:	e9 bd f9 ff ff       	jmp    801056b9 <alltraps>
...
80105cfe:	6a 2d                	push   $0x2d
  jmp alltraps
80105d00:	e9 b4 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d07:	6a 2e                	push   $0x2e
  jmp alltraps
80105d09:	e9 ab f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d10:	6a 2f                	push   $0x2f
  jmp alltraps
80105d12:	e9 a2 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d19:	6a 30                	push   $0x30
  jmp alltraps
80105d1b:	e9 99 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d22:	6a 31                	push   $0x31
  jmp alltraps
80105d24:	e9 90 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d2b:	6a 32                	push   $0x32
  jmp alltraps
80105d2d:	e9 87 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d34:	6a 33                	push   $0x33
  jmp alltraps
80105d36:	e9 7e f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d3d:	6a 34                	push   $0x34
  jmp alltraps
80105d3f:	e9 75 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d46:	6a 35                	push   $0x35
  jmp alltraps
80105d48:	e9 6c f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d4f:	6a 36                	push   $0x36
  jmp alltraps
80105d51:	e9 63 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d58:	6a 37                	push   $0x37
  jmp alltraps
80105d5a:	e9 5a f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d61:	6a 38                	push   $0x38
  jmp alltraps
80105d63:	e9 51 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d6a:	6a 39                	push   $0x39
  jmp alltraps
80105d6c:	e9 48 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d73:	6a 3a                	push   $0x3a
  jmp alltraps
80105d75:	e9 3f f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d7c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d7e:	e9 36 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d85:	6a 3c                	push   $0x3c
  jmp alltraps
80105d87:	e9 2d f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d8e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d90:	e9 24 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105d97:	6a 3e                	push   $0x3e
  jmp alltraps
80105d99:	e9 1b f9 ff ff       	jmp    801056b9 <alltraps>
...
80105da0:	6a 3f                	push   $0x3f
  jmp alltraps
80105da2:	e9 12 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105da9:	6a 40                	push   $0x40
  jmp alltraps
80105dab:	e9 09 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105db2:	6a 41                	push   $0x41
  jmp alltraps
80105db4:	e9 00 f9 ff ff       	jmp    801056b9 <alltraps>
...
80105dbb:	6a 42                	push   $0x42
  jmp alltraps
80105dbd:	e9 f7 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105dc4:	6a 43                	push   $0x43
  jmp alltraps
80105dc6:	e9 ee f8 ff ff       	jmp    801056b9 <alltraps>
...
80105dcd:	6a 44                	push   $0x44
  jmp alltraps
80105dcf:	e9 e5 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105dd6:	6a 45                	push   $0x45
  jmp alltraps
80105dd8:	e9 dc f8 ff ff       	jmp    801056b9 <alltraps>
...
80105ddf:	6a 46                	push   $0x46
  jmp alltraps
80105de1:	e9 d3 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105de8:	6a 47                	push   $0x47
  jmp alltraps
80105dea:	e9 ca f8 ff ff       	jmp    801056b9 <alltraps>
...
80105df1:	6a 48                	push   $0x48
  jmp alltraps
80105df3:	e9 c1 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105dfa:	6a 49                	push   $0x49
  jmp alltraps
80105dfc:	e9 b8 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e03:	6a 4a                	push   $0x4a
  jmp alltraps
80105e05:	e9 af f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e0c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e0e:	e9 a6 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e15:	6a 4c                	push   $0x4c
  jmp alltraps
80105e17:	e9 9d f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e1e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e20:	e9 94 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e27:	6a 4e                	push   $0x4e
  jmp alltraps
80105e29:	e9 8b f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e30:	6a 4f                	push   $0x4f
  jmp alltraps
80105e32:	e9 82 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e39:	6a 50                	push   $0x50
  jmp alltraps
80105e3b:	e9 79 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e42:	6a 51                	push   $0x51
  jmp alltraps
80105e44:	e9 70 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e4b:	6a 52                	push   $0x52
  jmp alltraps
80105e4d:	e9 67 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e54:	6a 53                	push   $0x53
  jmp alltraps
80105e56:	e9 5e f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e5d:	6a 54                	push   $0x54
  jmp alltraps
80105e5f:	e9 55 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e66:	6a 55                	push   $0x55
  jmp alltraps
80105e68:	e9 4c f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e6f:	6a 56                	push   $0x56
  jmp alltraps
80105e71:	e9 43 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e78:	6a 57                	push   $0x57
  jmp alltraps
80105e7a:	e9 3a f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e81:	6a 58                	push   $0x58
  jmp alltraps
80105e83:	e9 31 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e8a:	6a 59                	push   $0x59
  jmp alltraps
80105e8c:	e9 28 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e93:	6a 5a                	push   $0x5a
  jmp alltraps
80105e95:	e9 1f f8 ff ff       	jmp    801056b9 <alltraps>
...
80105e9c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e9e:	e9 16 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105ea5:	6a 5c                	push   $0x5c
  jmp alltraps
80105ea7:	e9 0d f8 ff ff       	jmp    801056b9 <alltraps>
...
80105eae:	6a 5d                	push   $0x5d
  jmp alltraps
80105eb0:	e9 04 f8 ff ff       	jmp    801056b9 <alltraps>
...
80105eb7:	6a 5e                	push   $0x5e
  jmp alltraps
80105eb9:	e9 fb f7 ff ff       	jmp    801056b9 <alltraps>
...
80105ec0:	6a 5f                	push   $0x5f
  jmp alltraps
80105ec2:	e9 f2 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105ec9:	6a 60                	push   $0x60
  jmp alltraps
80105ecb:	e9 e9 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105ed2:	6a 61                	push   $0x61
  jmp alltraps
80105ed4:	e9 e0 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105edb:	6a 62                	push   $0x62
  jmp alltraps
80105edd:	e9 d7 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105ee4:	6a 63                	push   $0x63
  jmp alltraps
80105ee6:	e9 ce f7 ff ff       	jmp    801056b9 <alltraps>
...
80105eed:	6a 64                	push   $0x64
  jmp alltraps
80105eef:	e9 c5 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105ef6:	6a 65                	push   $0x65
  jmp alltraps
80105ef8:	e9 bc f7 ff ff       	jmp    801056b9 <alltraps>
...
80105eff:	6a 66                	push   $0x66
  jmp alltraps
80105f01:	e9 b3 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f08:	6a 67                	push   $0x67
  jmp alltraps
80105f0a:	e9 aa f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f11:	6a 68                	push   $0x68
  jmp alltraps
80105f13:	e9 a1 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f1a:	6a 69                	push   $0x69
  jmp alltraps
80105f1c:	e9 98 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f23:	6a 6a                	push   $0x6a
  jmp alltraps
80105f25:	e9 8f f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f2c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f2e:	e9 86 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f35:	6a 6c                	push   $0x6c
  jmp alltraps
80105f37:	e9 7d f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f3e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f40:	e9 74 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f47:	6a 6e                	push   $0x6e
  jmp alltraps
80105f49:	e9 6b f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f50:	6a 6f                	push   $0x6f
  jmp alltraps
80105f52:	e9 62 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f59:	6a 70                	push   $0x70
  jmp alltraps
80105f5b:	e9 59 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f62:	6a 71                	push   $0x71
  jmp alltraps
80105f64:	e9 50 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f6b:	6a 72                	push   $0x72
  jmp alltraps
80105f6d:	e9 47 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f74:	6a 73                	push   $0x73
  jmp alltraps
80105f76:	e9 3e f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f7d:	6a 74                	push   $0x74
  jmp alltraps
80105f7f:	e9 35 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f86:	6a 75                	push   $0x75
  jmp alltraps
80105f88:	e9 2c f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f8f:	6a 76                	push   $0x76
  jmp alltraps
80105f91:	e9 23 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105f98:	6a 77                	push   $0x77
  jmp alltraps
80105f9a:	e9 1a f7 ff ff       	jmp    801056b9 <alltraps>
...
80105fa1:	6a 78                	push   $0x78
  jmp alltraps
80105fa3:	e9 11 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105faa:	6a 79                	push   $0x79
  jmp alltraps
80105fac:	e9 08 f7 ff ff       	jmp    801056b9 <alltraps>
...
80105fb3:	6a 7a                	push   $0x7a
  jmp alltraps
80105fb5:	e9 ff f6 ff ff       	jmp    801056b9 <alltraps>
...
80105fbc:	6a 7b                	push   $0x7b
  jmp alltraps
80105fbe:	e9 f6 f6 ff ff       	jmp    801056b9 <alltraps>
...
80105fc5:	6a 7c                	push   $0x7c
  jmp alltraps
80105fc7:	e9 ed f6 ff ff       	jmp    801056b9 <alltraps>
...
80105fce:	6a 7d                	push   $0x7d
  jmp alltraps
80105fd0:	e9 e4 f6 ff ff       	jmp    801056b9 <alltraps>
...
80105fd7:	6a 7e                	push   $0x7e
  jmp alltraps
80105fd9:	e9 db f6 ff ff       	jmp    801056b9 <alltraps>
...
80105fe0:	6a 7f                	push   $0x7f
  jmp alltraps
80105fe2:	e9 d2 f6 ff ff       	jmp    801056b9 <alltraps>
...
80105fe9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fee:	e9 c6 f6 ff ff       	jmp    801056b9 <alltraps>
...
80105ff5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105ffa:	e9 ba f6 ff ff       	jmp    801056b9 <alltraps>
...
80106001:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106006:	e9 ae f6 ff ff       	jmp    801056b9 <alltraps>
...
8010600d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106012:	e9 a2 f6 ff ff       	jmp    801056b9 <alltraps>
...
80106019:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010601e:	e9 96 f6 ff ff       	jmp    801056b9 <alltraps>
...
80106025:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010602a:	e9 8a f6 ff ff       	jmp    801056b9 <alltraps>
...
80106031:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106036:	e9 7e f6 ff ff       	jmp    801056b9 <alltraps>
...
8010603d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106042:	e9 72 f6 ff ff       	jmp    801056b9 <alltraps>
...
80106049:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010604e:	e9 66 f6 ff ff       	jmp    801056b9 <alltraps>
...
80106055:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010605a:	e9 5a f6 ff ff       	jmp    801056b9 <alltraps>
...
80106061:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106066:	e9 4e f6 ff ff       	jmp    801056b9 <alltraps>
...
8010606d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106072:	e9 42 f6 ff ff       	jmp    801056b9 <alltraps>
...
80106079:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010607e:	e9 36 f6 ff ff       	jmp    801056b9 <alltraps>
...
80106085:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010608a:	e9 2a f6 ff ff       	jmp    801056b9 <alltraps>
...
80106091:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106096:	e9 1e f6 ff ff       	jmp    801056b9 <alltraps>
...
8010609d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801060a2:	e9 12 f6 ff ff       	jmp    801056b9 <alltraps>
...
801060a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801060ae:	e9 06 f6 ff ff       	jmp    801056b9 <alltraps>
...
801060b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801060ba:	e9 fa f5 ff ff       	jmp    801056b9 <alltraps>
...
801060c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060c6:	e9 ee f5 ff ff       	jmp    801056b9 <alltraps>
...
801060cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060d2:	e9 e2 f5 ff ff       	jmp    801056b9 <alltraps>
...
801060d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060de:	e9 d6 f5 ff ff       	jmp    801056b9 <alltraps>
...
801060e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060ea:	e9 ca f5 ff ff       	jmp    801056b9 <alltraps>
...
801060f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060f6:	e9 be f5 ff ff       	jmp    801056b9 <alltraps>
...
801060fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106102:	e9 b2 f5 ff ff       	jmp    801056b9 <alltraps>
...
80106109:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010610e:	e9 a6 f5 ff ff       	jmp    801056b9 <alltraps>
...
80106115:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010611a:	e9 9a f5 ff ff       	jmp    801056b9 <alltraps>
...
80106121:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106126:	e9 8e f5 ff ff       	jmp    801056b9 <alltraps>
...
8010612d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106132:	e9 82 f5 ff ff       	jmp    801056b9 <alltraps>
...
80106139:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010613e:	e9 76 f5 ff ff       	jmp    801056b9 <alltraps>
...
80106145:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010614a:	e9 6a f5 ff ff       	jmp    801056b9 <alltraps>
...
80106151:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106156:	e9 5e f5 ff ff       	jmp    801056b9 <alltraps>
...
8010615d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106162:	e9 52 f5 ff ff       	jmp    801056b9 <alltraps>
...
80106169:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010616e:	e9 46 f5 ff ff       	jmp    801056b9 <alltraps>
...
80106175:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010617a:	e9 3a f5 ff ff       	jmp    801056b9 <alltraps>
...
80106181:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106186:	e9 2e f5 ff ff       	jmp    801056b9 <alltraps>
...
8010618d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106192:	e9 22 f5 ff ff       	jmp    801056b9 <alltraps>
...
80106199:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010619e:	e9 16 f5 ff ff       	jmp    801056b9 <alltraps>
...
801061a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801061aa:	e9 0a f5 ff ff       	jmp    801056b9 <alltraps>
...
801061b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801061b6:	e9 fe f4 ff ff       	jmp    801056b9 <alltraps>
...
801061bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061c2:	e9 f2 f4 ff ff       	jmp    801056b9 <alltraps>
...
801061c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061ce:	e9 e6 f4 ff ff       	jmp    801056b9 <alltraps>
...
801061d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061da:	e9 da f4 ff ff       	jmp    801056b9 <alltraps>
...
801061e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061e6:	e9 ce f4 ff ff       	jmp    801056b9 <alltraps>
...
801061ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061f2:	e9 c2 f4 ff ff       	jmp    801056b9 <alltraps>
...
801061f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061fe:	e9 b6 f4 ff ff       	jmp    801056b9 <alltraps>
...
80106205:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010620a:	e9 aa f4 ff ff       	jmp    801056b9 <alltraps>
...
80106211:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106216:	e9 9e f4 ff ff       	jmp    801056b9 <alltraps>
...
8010621d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106222:	e9 92 f4 ff ff       	jmp    801056b9 <alltraps>
...
80106229:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010622e:	e9 86 f4 ff ff       	jmp    801056b9 <alltraps>
...
80106235:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010623a:	e9 7a f4 ff ff       	jmp    801056b9 <alltraps>
...
80106241:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106246:	e9 6e f4 ff ff       	jmp    801056b9 <alltraps>
...
8010624d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106252:	e9 62 f4 ff ff       	jmp    801056b9 <alltraps>
...
80106259:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010625e:	e9 56 f4 ff ff       	jmp    801056b9 <alltraps>
...
80106265:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010626a:	e9 4a f4 ff ff       	jmp    801056b9 <alltraps>
...
80106271:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106276:	e9 3e f4 ff ff       	jmp    801056b9 <alltraps>
...
8010627d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106282:	e9 32 f4 ff ff       	jmp    801056b9 <alltraps>
...
80106289:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010628e:	e9 26 f4 ff ff       	jmp    801056b9 <alltraps>
...
80106295:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010629a:	e9 1a f4 ff ff       	jmp    801056b9 <alltraps>
...
801062a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801062a6:	e9 0e f4 ff ff       	jmp    801056b9 <alltraps>
...
801062ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801062b2:	e9 02 f4 ff ff       	jmp    801056b9 <alltraps>
...
801062b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801062be:	e9 f6 f3 ff ff       	jmp    801056b9 <alltraps>
...
801062c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062ca:	e9 ea f3 ff ff       	jmp    801056b9 <alltraps>
...
801062d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062d6:	e9 de f3 ff ff       	jmp    801056b9 <alltraps>
...
801062dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062e2:	e9 d2 f3 ff ff       	jmp    801056b9 <alltraps>
...
801062e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062ee:	e9 c6 f3 ff ff       	jmp    801056b9 <alltraps>
...
801062f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062fa:	e9 ba f3 ff ff       	jmp    801056b9 <alltraps>
...
80106301:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106306:	e9 ae f3 ff ff       	jmp    801056b9 <alltraps>
...
8010630d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106312:	e9 a2 f3 ff ff       	jmp    801056b9 <alltraps>
...
80106319:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010631e:	e9 96 f3 ff ff       	jmp    801056b9 <alltraps>
...
80106325:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010632a:	e9 8a f3 ff ff       	jmp    801056b9 <alltraps>
...
80106331:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106336:	e9 7e f3 ff ff       	jmp    801056b9 <alltraps>
...
8010633d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106342:	e9 72 f3 ff ff       	jmp    801056b9 <alltraps>
...
80106349:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010634e:	e9 66 f3 ff ff       	jmp    801056b9 <alltraps>
...
80106355:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010635a:	e9 5a f3 ff ff       	jmp    801056b9 <alltraps>
...
80106361:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106366:	e9 4e f3 ff ff       	jmp    801056b9 <alltraps>
...
8010636d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106372:	e9 42 f3 ff ff       	jmp    801056b9 <alltraps>
...
80106379:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010637e:	e9 36 f3 ff ff       	jmp    801056b9 <alltraps>
...
80106385:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010638a:	e9 2a f3 ff ff       	jmp    801056b9 <alltraps>
...
80106391:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106396:	e9 1e f3 ff ff       	jmp    801056b9 <alltraps>
...
8010639d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801063a2:	e9 12 f3 ff ff       	jmp    801056b9 <alltraps>
...
801063a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801063ae:	e9 06 f3 ff ff       	jmp    801056b9 <alltraps>
...
801063b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801063ba:	e9 fa f2 ff ff       	jmp    801056b9 <alltraps>
...
801063c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063c6:	e9 ee f2 ff ff       	jmp    801056b9 <alltraps>
...
801063cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063d2:	e9 e2 f2 ff ff       	jmp    801056b9 <alltraps>
...
801063d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063de:	e9 d6 f2 ff ff       	jmp    801056b9 <alltraps>
...
801063e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063ea:	e9 ca f2 ff ff       	jmp    801056b9 <alltraps>
...
801063f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063f6:	e9 be f2 ff ff       	jmp    801056b9 <alltraps>
...
801063fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106402:	e9 b2 f2 ff ff       	jmp    801056b9 <alltraps>
...
80106409:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010640e:	e9 a6 f2 ff ff       	jmp    801056b9 <alltraps>
...
80106415:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010641a:	e9 9a f2 ff ff       	jmp    801056b9 <alltraps>
...
80106421:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106426:	e9 8e f2 ff ff       	jmp    801056b9 <alltraps>
...
8010642d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106432:	e9 82 f2 ff ff       	jmp    801056b9 <alltraps>
...
80106439:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010643e:	e9 76 f2 ff ff       	jmp    801056b9 <alltraps>
...
80106445:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010644a:	e9 6a f2 ff ff       	jmp    801056b9 <alltraps>
...
80106451:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106456:	e9 5e f2 ff ff       	jmp    801056b9 <alltraps>
...
8010645d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106462:	e9 52 f2 ff ff       	jmp    801056b9 <alltraps>
...
80106469:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010646e:	e9 46 f2 ff ff       	jmp    801056b9 <alltraps>
...
80106475:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010647a:	e9 3a f2 ff ff       	jmp    801056b9 <alltraps>
...
80106481:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106486:	e9 2e f2 ff ff       	jmp    801056b9 <alltraps>
...
8010648d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106492:	e9 22 f2 ff ff       	jmp    801056b9 <alltraps>
...
80106499:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010649e:	e9 16 f2 ff ff       	jmp    801056b9 <alltraps>
...
801064a5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801064aa:	e9 0a f2 ff ff       	jmp    801056b9 <alltraps>
...
801064b1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801064b6:	e9 fe f1 ff ff       	jmp    801056b9 <alltraps>
...
801064bd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064c2:	e9 f2 f1 ff ff       	jmp    801056b9 <alltraps>
...
801064c9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064ce:	e9 e6 f1 ff ff       	jmp    801056b9 <alltraps>
...
801064d5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064da:	e9 da f1 ff ff       	jmp    801056b9 <alltraps>
...
801064e1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064e6:	e9 ce f1 ff ff       	jmp    801056b9 <alltraps>
...
801064ed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064f2:	e9 c2 f1 ff ff       	jmp    801056b9 <alltraps>
...
801064f9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064fe:	e9 b6 f1 ff ff       	jmp    801056b9 <alltraps>
...
80106505:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010650a:	e9 aa f1 ff ff       	jmp    801056b9 <alltraps>
...
80106511:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106516:	e9 9e f1 ff ff       	jmp    801056b9 <alltraps>
...
8010651d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106522:	e9 92 f1 ff ff       	jmp    801056b9 <alltraps>
...
80106529:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010652e:	e9 86 f1 ff ff       	jmp    801056b9 <alltraps>
...
80106535:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010653a:	e9 7a f1 ff ff       	jmp    801056b9 <alltraps>
...
80106541:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106546:	e9 6e f1 ff ff       	jmp    801056b9 <alltraps>
...
8010654d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106552:	e9 62 f1 ff ff       	jmp    801056b9 <alltraps>
...
80106559:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010655e:	e9 56 f1 ff ff       	jmp    801056b9 <alltraps>
...
80106565:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010656a:	e9 4a f1 ff ff       	jmp    801056b9 <alltraps>
...
80106571:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106576:	e9 3e f1 ff ff       	jmp    801056b9 <alltraps>
...
8010657d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106582:	e9 32 f1 ff ff       	jmp    801056b9 <alltraps>
...
80106589:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010658e:	e9 26 f1 ff ff       	jmp    801056b9 <alltraps>
...
80106595:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010659a:	e9 1a f1 ff ff       	jmp    801056b9 <alltraps>
...
801065a1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801065a6:	e9 0e f1 ff ff       	jmp    801056b9 <alltraps>
...
801065ad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801065b2:	e9 02 f1 ff ff       	jmp    801056b9 <alltraps>
...
801065b9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801065be:	e9 f6 f0 ff ff       	jmp    801056b9 <alltraps>
...
801065c5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065ca:	e9 ea f0 ff ff       	jmp    801056b9 <alltraps>
...
801065d1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065d6:	e9 de f0 ff ff       	jmp    801056b9 <alltraps>
...
801065dd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065e2:	e9 d2 f0 ff ff       	jmp    801056b9 <alltraps>
...
801066ed:	68 8c 78 10 80       	push   $0x8010788c
...
801067a3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801067a6:	e8 a5 cf ff ff       	call   80103750 <cpuid>
...
801068ef:	e8 dc cd ff ff       	call   801036d0 <mycpu>
801068f4:	89 c3                	mov    %eax,%ebx
801068f6:	e8 d5 cd ff ff       	call   801036d0 <mycpu>
801068fb:	89 c7                	mov    %eax,%edi
801068fd:	e8 ce cd ff ff       	call   801036d0 <mycpu>
...
80106949:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010694e:	e8 7d cd ff ff       	call   801036d0 <mycpu>
80106953:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010695a:	e8 71 cd ff ff       	call   801036d0 <mycpu>
8010695f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106964:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106968:	e8 63 cd ff ff       	call   801036d0 <mycpu>
...
80106976:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106979:	e8 52 cd ff ff       	call   801036d0 <mycpu>
...
8010699b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010699c:	e9 6f d9 ff ff       	jmp    80104310 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
801069a4:	68 92 78 10 80       	push   $0x80107892
...
801069b1:	68 bd 78 10 80       	push   $0x801078bd
...
801069be:	68 a8 78 10 80       	push   $0x801078a8
...
80106a39:	68 d1 78 10 80       	push   $0x801078d1
...
80106aed:	68 eb 78 10 80       	push   $0x801078eb
...
80106afa:	68 8c 79 10 80       	push   $0x8010798c
...
80106b91:	68 09 79 10 80       	push   $0x80107909
...
80106bc3:	68 21 79 10 80       	push   $0x80107921
...
80106cac:	68 3d 79 10 80       	push   $0x8010793d
...
80106d7f:	68 4e 79 10 80       	push   $0x8010794e
...
80106e75:	68 72 79 10 80       	push   $0x80107972
...
80106e82:	68 58 79 10 80       	push   $0x80107958
...
80106f0f:	e8 4c d6 ff ff       	call   80104560 <memmove>
    len -= n;
    buf += n;
